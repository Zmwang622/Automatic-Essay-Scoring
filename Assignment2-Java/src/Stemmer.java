...
public class Stemmer implements Function<Word,Word> {
  ...
  */
  ...
  public static void main(String[] args) throws IOException 
  {
    ...
    Iterator<Word> it = PTBTokenizer.newPTBTokenizer(new FileReader(f));
    BufferedWriter writer = new 
			BufferedWriter(new FileWriter("C:/Users/mingw/FER/Assignment2-Java/Bodies_Stemmed_Java.txt"));
    while (it.hasNext()) 
    {
    	Word token = it.next();
        writer.write(s.stem(token.word()));
        writer.newLine();
    } 
